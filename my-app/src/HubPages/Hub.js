...
<text className="font-bold text-yellow-300"> {data.tag} </text>
				...
				{data.posts.map((post) => 
				<div className="shadow-lg group container max-w-sm flex justify-center items-center  mx-auto  content-div w-52 h-autorounded-xl hover:opacity-30 rounded-xl" style={post.styles}> 
				<div>
